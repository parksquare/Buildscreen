...
namespace ParkSquare.BuildScreen.Web.Services.Gravatar
{
    public class GravatarProvider : IAvatarProvider
    {
        ...
        public async Task<Avatar> GetAvatarAsync(AvatarId avatarId, ImageDimensions dimensions)
        {
            try
            {
            ...
            return new Avatar {Data = CreateTransparentPixel(), ContentType = PngFormat.Instance.DefaultMimeType};
        }
